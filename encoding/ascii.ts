/**
Mapping from Unicode name (or Unicode 1 [old] name for the control characters)
to the corresponding numeric character code in the ASCII/UTF-8 charset.
*/
enum ascii {
  // the indices are superfluous, since they follow the default TypeScript enum
  // ordering, but are present for the sake of clarity.
  NULL = 0,
  START_OF_HEADING = 1,
  START_OF_TEXT = 2,
  END_OF_TEXT = 3,
