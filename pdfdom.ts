...
export interface IndirectReference {
  ...
  /** non-negative integer, usually 0 */
  generation_number: number;
}

/** An object declaration. For example, the following snippet would evaluate
to {object_number: 11, generation_number: 0, value: "Hello World!"}
...
See 7.3.10, PDF32000_2008.pdf:29
*/
export interface IndirectObject extends IndirectReference {
  value: any;
}
...
*/
export interface CrossReference extends IndirectReference {
  in_use: boolean;
